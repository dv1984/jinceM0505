...
class Config(): # 【公共】WEB配置类
    ...
    def init_app(app): # 项目的初始化配置
        ...
        config_filter(app)
    SECRET_KEY = "www.yootk.com-%s" % os.urandom(24)  # 定义加密配置
...
class DevelopmentConfig(Config): # 【某个环境】专属的配置类
    ...
    SQLALCHEMY_DATABASE_URI = "mysql+mysqlconnector://jince_db_01:Jince0331@rm-bp1561n11704142t89o.mysql.rds.aliyuncs.com:3306/yootk_flask"
